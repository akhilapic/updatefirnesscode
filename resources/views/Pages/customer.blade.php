									...
									<tr>
										...
										<td>
											<div class="table_action">
												<a href="javascript:void(0);" class="btn btn-success btn-sm list_view infoU" data-bs-toggle="modal"  data-id='"{{ $user->id }}"' data-bs-target="#customer_details_modal" data-bs-whatever="@mdo">
												...
												<a href="{{ route('user_edit',$user->id) }}" class="btn btn-info btn-sm list_edit">
